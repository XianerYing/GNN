...
import GNN_symmetric.pack.nn.neighbors
from pack.data import Structure
from GNN_symmetric.pack.nn.cutoff import HardCutoff
from GNN_symmetric.pack.representation import Interaction_module, batch_index_select
...
class SYGNN(nn.Module):
    ...
    def __init__(self, n_atom_basis=128, n_filters=128, n_interactions=1, cutoff=5.0, n_gaussians=25,
        ...
        # spatial features
        self.distances = GNN_symmetric.pack.nn.neighbors.AtomDistances()
